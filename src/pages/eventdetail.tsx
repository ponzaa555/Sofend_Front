    ...
    return(
        <>
            ...
            <div className='flex flex-col mb-32'>
                <div className=" bg-green-300 h-52 mb-20" >
                    <div className='mx-auto lg:max-w-7xl md:items-center md:px-8'>
                        <div className='flex flex-row justify-center'>
                            ...
                            <div className='ml-16'>
                                <div className='text-white font-montserrat font-bold text-2xl mb-5'>exhibition</div>
                                <div className='text-black font-montserrat font-bold text-2xl mb-5'>THE WORLD OF STUDIO GHIBLI'S ANIMATION EXHIBITION BANGKOK 2023</div>
                                <div className='text-black font-montserrat font-bold text-xl mb-5'>1 July 2023 - 31 December 2023</div>
                                <div className='text-black font-montserrat font-bold text-xl mb-5'>11:00-21:00</div>
                                <div className='text-black font-montserrat font-bold text-xl mb-5'>Central World Bangkok</div>
                                <button className="bg-white hover:bg-black hover:text-white border-2 border-black duration-300 text-black font-bold py-2 rounded mt-2 mb-2 box-content h-6 w-32 mr-5" onClick={handleClick}>Get Tickets</button>
                            </div>
                    </div>
                </div>
                </div>
                ...
                <div className=' text-black font-montserrat font-bold mb-5' ref={ref}>Ticket</div>
                    <div className='flex flex-row justify-between gap-5'>
                        <div className="basis-3/5">
                            <div className='flex flex-col gap-5'>
                                <div className='grid grid-cols-5 justify-around border-2 border-gray-300 rounded-md place-items-center pl-5 pr-5'>
                                    ...
                                    <button onClick={()=>setCountNormal(countNormal-1)}  disabled={countNormal<=0} className="bg-white hover:bg-black hover:text-white border-2 border-black duration-300 text-black font-bold rounded mt-2 mb-2 box-content h-6 w-6 mr-5 text-center" type="submit"><p className='text-center'>-</p></button>
                                    <div className='font-montserrat'>{countNormal}</div>
                                    <button onClick={()=>setCountNormal(countNormal+1)}className="bg-white hover:bg-black hover:text-white border-2 border-black duration-300 text-black font-bold rounded mt-2 mb-2 box-content h-6 w-6 mr-5 text-center" type="submit">+</button>
                                </div>
                                <div className='grid grid-cols-5 justify-around border-2 border-gray-300 rounded-md place-items-center pl-5 pr-5'>
                                    <div className='font-montserrat'>VIP</div>
                                    <div className='font-montserrat font-bold'>1,000 ฿</div>
                                    <button onClick={()=>setCountVIP(countVIP-1)} disabled={countVIP<=0} className="bg-white hover:bg-black hover:text-white border-2 border-black duration-300 text-black font-bold rounded mt-2 mb-2 box-content h-6 w-6 mr-5 text-center" type="submit">-</button>
                                    <div className='font-montserrat'>{countVIP}</div>
                                    <button onClick={()=>setCountVIP(countVIP+1)} className="bg-white hover:bg-black hover:text-white border-2 border-black duration-300 text-black font-bold rounded mt-2 mb-2 box-content h-6 w-6 mr-5 text-center" type="submit">+</button>
                                </div>
                            </div>
                        </div>
                        <div className="basis-2/4">
                            ...
                            <button disabled={countNormal<=0 && countVIP<=0} className="bg-white hover:bg-black hover:text-white border-2 border-black duration-300 text-black font-bold py-2 rounded mt-2 mb-2 box-content w-full">Check out</button>
                        </div>
                    </div>
            </div>
            <div className='mx-auto lg:max-w-7xl md:items-center md:flex-col md:px-8 mb-10'>
