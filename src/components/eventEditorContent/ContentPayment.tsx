  ...
  <div className=' h-full'>
      <div className=' flex justify-center  h-1/2  gap-10'>
        <form id='left' className=' relative w-2/3 h-full  font-montserrat '>
          ...
          <div>
            <div className='text-xl pt-2'>
              ...
              <div>
                <input type="text" className='w-full rounded h-9  border-gray-500 border bg-transparent ' />
              </div>
            </div>
          </div>
          <div id='Nameandtype' className='pt-2'>
            <div className='flex text-xl gap-4'>
              ...
              <div id='inputNametype' className='flex gap-4'>
                <div className='w-3/5'>
                  <input className='w-full rounded h-9  border-gray-500 border bg-transparent ' />
                </div>
                <div className='w-2/5'>
                  <input className='w-full rounded h-9  border-gray-500 border bg-transparent' />
                </div>
        ...
        <div id='right' className=' w-1/3 h-full'>
          ...
          <div className='pt-2'>
            <div>
              <h1 className=' font-semibold text-lg'>Bank Accounts</h1>
            </div>
