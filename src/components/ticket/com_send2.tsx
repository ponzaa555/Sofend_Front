    ...
    return(
        <>
            <div className="grid grid-col place-content-center justify-items-center gap-4 place-items-center mt-28">
                ...
                <button className="bg-black hover:bg-black hover:text-white border-2 border-black duration-300 text-white font-bold py-2 rounded mt-2 mb-2 box-content h-6 w-32 font-montserrat">My Ticket</button>
            </div>      
        </>
    )
}
